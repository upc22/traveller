...
export class UserListComponent extends BaseListComponent<InterfaceProviders.User>  {
  ...
  constructor(protected titleService: Title,
    ...
    super(titleService, spinnerService, kendoDialog, datacontextService.UserApi, router, activatedRoute);
