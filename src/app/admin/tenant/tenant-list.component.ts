...
export class TenantListComponent extends BaseListComponent<InterfaceProviders.Tenant>  {
  ...
  constructor(protected titleService: Title,
    ...
    super(titleService, spinnerService, kendoDialog, datacontextService.TenantApi, router, activatedRoute);
