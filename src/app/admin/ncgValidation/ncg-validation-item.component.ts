...
export class NcgValidationItemComponent extends BaseItemComponent<InterfaceProviders.NcgValidation> {
  ...
  constructor(
    ...
    protected restoreService: RestoreService<InterfaceProviders.NcgValidation>,
