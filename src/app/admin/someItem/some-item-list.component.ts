...
export class SomeItemListComponent extends BaseListComponent<InterfaceProviders.SomeItem>  {
  ...
  constructor(protected titleService: Title,
    ...
    super(titleService, spinnerService, kendoDialog, datacontextService.SomeItemApi, router, activatedRoute);
