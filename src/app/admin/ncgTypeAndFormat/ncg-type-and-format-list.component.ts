...
export class NcgTypeAndFormatListComponent extends BaseListComponent<InterfaceProviders.NcgTypeAndFormat>  {
  ...
  constructor(protected titleService: Title,
    ...
    super(titleService, spinnerService, kendoDialog, datacontextService.NcgTypeAndFormatApi, router, activatedRoute);
