...
export class ValidationService { // extends Validators {
  ...
  public static addFormError(formErrors, fieldKey, validationType, customValidationMessages, formMetaData) {
  ...
  public static getGenericValidationMessage(fieldKey, validationType, formMetaData): string {
  ...
  // public static minimumValidator(minimumValue) {
  //   return function (control) {
  ...
  // public static maximumValidator(maximumValue) {
  //   return function (control) {
  ...
  public static phoneFormatValidation(type) {
    return function (control) {
      switch (type) {
        case 'US':
          return undefined;
  ...
  public static numberRangeValidator(firstValue, secondValue, type) {
    return function (control) {
      switch (type) {
        case '<>':
