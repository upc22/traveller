...
export class NcgOtherListComponent extends BaseListComponent<InterfaceProviders.NcgOther>  {
  ...
  constructor(protected titleService: Title,
    ...
    super(titleService, spinnerService, kendoDialog, datacontextService.NcgOtherApi, router, activatedRoute);
